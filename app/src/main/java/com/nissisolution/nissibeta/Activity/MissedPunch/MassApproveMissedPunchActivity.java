...
import com.nissisolution.nissibeta.Adapter.Approve.ApproveMissedPunchAdapter;
...
public class MassApproveMissedPunchActivity extends AppCompatActivity {
    ...
    private ApproveMissedPunchAdapter approve_missed_punch_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mass_approve_missed_punch);
    ...
    private void select_or_deselect() {
        if (isSelected) {
            ...
            for (AdminMissedPunch h:
                    admin_missed_punch_list) {
                if (h.status == 0) {
                    h.isChecked = true;
                }
            }
    ...
    private void set_recycler_view() {
        approve_missed_punch_adapter = new ApproveMissedPunchAdapter(context, Filter.filterAdminMissedPunch(admin_missed_punch_list, 1), selection, isSelected);
        layoutManager = new LinearLayoutManager(context);
        layoutManager.setOrientation(RecyclerView.VERTICAL);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(approve_missed_punch_adapter);
    }
