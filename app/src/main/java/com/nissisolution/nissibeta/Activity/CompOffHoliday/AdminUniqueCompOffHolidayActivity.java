...
public class AdminUniqueCompOffHolidayActivity extends AppCompatActivity {

    private LinearLayout rejection_layout;
    private TextView rejection_reason;
    private int status = 0;
    private Context context;
    private TextView staff_name, position, request_date, requested_on, reason, licence;
    private RecyclerView recyclerView;
    private ProgressBar progressBar;
    private PreferencesManager preferencesManager;
    private Supports supports;
    private Intent get_intent;
    private String the_data, request_type, timestamp, staff_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_unique_comp_off_holiday);
    ...
    private void set_toolbar() {
        ...
        if (request_type.equals(Constants.KEY_1)) {
            getSupportActionBar().setTitle(getResources().getString(R.string.comp_off));
        } else if (request_type.equals(Constants.KEY_2)) {
            getSupportActionBar().setTitle(getResources().getString(R.string.holiday));
        } else if (request_type.equals(Constants.KEY_3)) {
            getSupportActionBar().setTitle(getString(R.string.night_shift));
        }
    ...
    private void get_recycler() {
        ...
        rejection_reason.setText(list_1.get(9));
    }
    ...
    private void approve_or_reject(String type) {
                ...
                }, error -> supports.create_short_toast(Constants.KEY_SOMETHING_WENT_WRONG))
        {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constants.KEY_ID, request_type);
