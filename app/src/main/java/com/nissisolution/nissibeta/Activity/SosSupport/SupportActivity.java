...
public class SupportActivity extends AppCompatActivity {
    ...
    private List<SupportSos> supportlist;
    ...
    private void set_request() {
        StringRequest request = new StringRequest(Request.Method.POST, Constants.KEY_GUESTHOUSE_LINK, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Constants.KEY_REQUEST_TYPE, Constants.KEY_GET_SUPPORT_MESSAGE);
                return params;
            }
        };
    ...
    private void set_recycler(){
        ...
        support_sos_adapter = new SupportSosAdapter(Constants.KEY_SUPPORT_MESSAGE, context, supportlist);
