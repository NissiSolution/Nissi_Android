...
import com.nissisolution.nissibeta.Adapter.AdminMissedPunch.AdminMissedPunchAdapter;
...
public class AdminMissedPunchActivity extends AppCompatActivity {
    ...
    private List<AdminMissedPunch> admin_missed_punch_list;
    private AdminMissedPunchAdapter admin_missed_punch_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_missed_punch_admin);
    ...
    private void updateViewed() {
        StringRequest request = new StringRequest(Request.Method.POST, Constants.KEY_DATABASE_LINK,
            ...
            protected Map<String, String> getParams() {
                ...
                map.put(Constants.KEY_TYPE, Constants.KEY_110);
    ...
    private void declare_item() {
        ...
        admin_missed_punch_list = new ArrayList<>();
    ...
    private void set_toolbar() {
        ...
        getSupportActionBar().setTitle(getResources().getString(R.string.missed_punch_request));
    ...
    private void get_request_data() {
                ...
                this::handle_request_data, error -> supports.create_short_toast(Constants.KEY_SOMETHING_WENT_WRONG))
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Constants.KEY_REQUEST_TYPE, Constants.KEY_GET_MISSED_PUNCH_APPROVAL_REQUEST);
...
//                params.put(Constants.KEY_STAFF_ID, "2");
    ...
    private void handle_request_data(String the_response) {
        ...
        for (int i = 1; i < list_1.size(); i++) {
            ...
            try {
                AdminMissedPunch admin_missed_punch = new AdminMissedPunch(list_2.get(0), list_2.get(5), "From " + list_2.get(9) + " to " + list_2.get(10),
                        list_1.get(i), supports.get_current_status(list_2.get(2)), Long.parseLong(list_2.get(3)), false);
                admin_missed_punch_list.add(admin_missed_punch);
    ...
    private void set_recycler_view() {
        admin_missed_punch_adapter = new AdminMissedPunchAdapter(context, Filter.filterAdminMissedPunch(admin_missed_punch_list, type_spinner.getSelectedItemPosition()), isSelected, selected_month, selected_year);
        layoutManager = new LinearLayoutManager(context);
        layoutManager.setOrientation(RecyclerView.VERTICAL);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(admin_missed_punch_adapter);
    }
