...
public class MyUniqueCompOffHolidayActivity extends AppCompatActivity {

    private LinearLayout rejection_layout;
    private Context context;
    private TextView licence, request_date, working_hours, requested_on, reason, rejection_reason;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_unique_comp_off_holiday);
    ...
    private void get_recycler() {
        ...
        reason.setText(list_1.get(5));
        get_staff_info(list_1.get(2));
        rejection_reason.setText(list_1.get(6));
    }
