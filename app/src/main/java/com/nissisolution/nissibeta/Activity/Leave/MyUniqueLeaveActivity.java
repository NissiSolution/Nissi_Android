...
public class MyUniqueLeaveActivity extends AppCompatActivity {

    private LinearLayout rejection_layout;
    private TextView leave_type, purpose, requested_on, duration, reason, licence, period, rejection_reason, firstHalf, secondHalf;
    ...
    private String the_data, request_type;
    private LinearLayoutManager layoutManager;
    private int status = 0, halfDay;
    private LinearLayout firstHalfLayout, secondHalfLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_unique_leave);
    ...
    private void get_recycler() {
        ...
        requested_on.setText(get_date(Long.parseLong(list_1.get(4))));
        leave_type.setText(request_type);
        get_leave_data(list_1.get(2));
        get_staff_info(list_1.get(3));
        rejection_reason.setText(list_1.get(10));
        halfDay = Integer.parseInt(list_1.get(11));
        if (halfDay == 0) {
    ...
    private void handle_response(String the_response) {
        ...
        if (list_a.get(0).equals(list_a.get(1))) {
            period.setText("On " + getDate2(list_1.get(0)));
            duration.setText(list_a.get(6) + " day");
        } else {
            period.setText("From " + getDate2(list_1.get(0)) + " to " + getDate2(list_2.get(0)));
        ...
        firstHalf.setText(getDate2(list_1.get(0)));
        secondHalf.setText(getDate2(list_2.get(0)));
        reason.setText(list_a.get(3));
    }

    private String getDate2(String the_date) {
