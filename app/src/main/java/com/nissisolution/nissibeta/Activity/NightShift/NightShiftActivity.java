...
public class NightShiftActivity extends AppCompatActivity {
    ...
    private void updateViewed() {
        StringRequest request = new StringRequest(Request.Method.POST, Constants.KEY_DATABASE_LINK,
            ...
            protected Map<String, String> getParams() {
                ...
                map.put(Constants.KEY_TYPE, Constants.KEY_3);
    ...
    private void set_toolbar() {
        ...
        getSupportActionBar().setTitle(getResources().getString(R.string.night_shift));
    ...
    private void get_request_data() {
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Constants.KEY_REQUEST_TYPE, Constants.KEY_GET_NIGHT_SHIFT);
